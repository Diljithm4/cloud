...
//        b1=(Button)findViewById(R.id.browse1);
//        ed1=(EditText)findViewById(R.id.edit1);
//        b2=(Button)findViewById(R.id.offload1);
//
//        SharedPreferences sh=PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
//        uid=sh.getString("id", "");
//
//        con=cloud_home_new.con;
//
//
//        nw=cloud_home_new.nw;
//        //SharedPreferences sh=PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
...
//
//
//        url1="http://"+ip+"/filetable";
//        url2="http://"+ip+"/uptable";
//
//
...
//
//
//                    String result = jobj.getString("task");
//
//
//
//
...
//        List<NameValuePair> params = new ArrayList<>();
//        params.add(new BasicNameValuePair("uid", uid));
//        params.add(new BasicNameValuePair("ftyp", atype));
//        params.add(new BasicNameValuePair("fsize", sz));
//        params.add(new BasicNameValuePair("fname", cdate));
//
//
//        JSONObject jobj = null;
//        try {
