    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                params.add(new BasicNameValuePair("login", mail));
                params.add(new BasicNameValuePair("login", password));
                ...
                try {
                    ...
                    if (ss.equals("invalid")) {
                        ...
                        Intent i = new Intent(getApplicationContext(), committe_home.class);
                        startActivity(i);
